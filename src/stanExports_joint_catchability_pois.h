...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_joint_catchability_pois");
    reader.add_event(68, 66, "end", "model_joint_catchability_pois");
    return reader;
}
#include <stan_meta_header.hpp>
class model_joint_catchability_pois
  : public stan::model::model_base_crtp<model_joint_catchability_pois> {
private:
        int S;
        int C;
        std::vector<int> L;
...
public:
    ...
    std::string model_name() const {
        return "model_joint_catchability_pois";
    }
...
typedef model_joint_catchability_pois_namespace::model_joint_catchability_pois stan_model;
#ifndef USING_R
