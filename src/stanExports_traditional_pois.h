...
namespace model_traditional_pois_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_traditional_pois");
    reader.add_event(38, 36, "end", "model_traditional_pois");
    return reader;
}
#include <stan_meta_header.hpp>
class model_traditional_pois
  : public stan::model::model_base_crtp<model_traditional_pois> {
private:
        int C;
        std::vector<int> R;
        int Nloc;
        std::vector<int> E;
public:
    model_traditional_pois(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_traditional_pois_namespace::model_traditional_pois";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            for (int j = 1; j <= C; ++j) {
                ...
                lp_accum__.add(poisson_log<propto__>(get_base1(E, j, "E", 1), get_base1(mu, get_base1(R, j, "R", 1), "mu", 1)));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_traditional_pois_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        try {
            ...
            for (int j = 1; j <= C; ++j) {
                ...
                stan::model::assign(log_lik, 
                            ...
                            poisson_log(get_base1(E, j, "E", 1), get_base1(mu, get_base1(R, j, "R", 1), "mu", 1)), 
...
typedef model_traditional_pois_namespace::model_traditional_pois stan_model;
#ifndef USING_R
