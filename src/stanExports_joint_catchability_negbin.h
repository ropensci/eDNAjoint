...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_joint_catchability_negbin");
    reader.add_event(69, 67, "end", "model_joint_catchability_negbin");
    return reader;
}
#include <stan_meta_header.hpp>
class model_joint_catchability_negbin
  : public stan::model::model_base_crtp<model_joint_catchability_negbin> {
private:
        int S;
        int C;
        std::vector<int> L;
...
public:
        ...
        try {
            ...
            for (int i = 1; i <= Nloc; ++i) {
                ...
                stan::model::assign(p11, 
                            ...
                            (get_base1(mu, i, "mu", 1) / (get_base1(mu, i, "mu", 1) + stan::math::exp(beta))), 
    ...
    std::string model_name() const {
        return "model_joint_catchability_negbin";
    }
...
typedef model_joint_catchability_negbin_namespace::model_joint_catchability_negbin stan_model;
#ifndef USING_R
