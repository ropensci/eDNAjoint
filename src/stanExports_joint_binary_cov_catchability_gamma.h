...
public:
  ...
  model_joint_binary_cov_catchability_gamma(stan::io::var_context& context__,
    ...
    num_params_r__ = Nloc + Nloc + 1 + nsitecov + nparams;
  }
  ...
  write_array(RNG& base_rng, Eigen::Matrix<double,-1,1>& params_r,
    ...
    const size_t num_params__ = ((((Nloc + Nloc) + 1) + nsitecov) + nparams);
