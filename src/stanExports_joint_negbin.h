...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_joint_negbin");
    reader.add_event(58, 56, "end", "model_joint_negbin");
    return reader;
}
#include <stan_meta_header.hpp>
class model_joint_negbin
  : public stan::model::model_base_crtp<model_joint_negbin> {
private:
        int S;
        int C;
        std::vector<int> L;
...
typedef model_joint_negbin_namespace::model_joint_negbin stan_model;
#ifndef USING_R
