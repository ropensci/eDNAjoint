...
#include "stanExports_traditional_gamma.h"

RCPP_MODULE(stan_fit4traditional_gamma_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_traditional_gamma")
