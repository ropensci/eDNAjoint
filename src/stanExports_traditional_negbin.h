...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_traditional_negbin");
    reader.add_event(38, 36, "end", "model_traditional_negbin");
    return reader;
}
#include <stan_meta_header.hpp>
class model_traditional_negbin
  : public stan::model::model_base_crtp<model_traditional_negbin> {
private:
        int C;
        std::vector<int> R;
        int Nloc;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            for (int j = 1; j <= C; ++j) {
                ...
                lp_accum__.add(neg_binomial_2_log<propto__>(get_base1(E, j, "E", 1), get_base1(mu, get_base1(R, j, "R", 1), "mu", 1), phi));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
        ...
        try {
            ...
            for (int j = 1; j <= C; ++j) {
                ...
                stan::model::assign(log_lik, 
                            ...
                            neg_binomial_2_log(get_base1(E, j, "E", 1), get_base1(mu, get_base1(R, j, "R", 1), "mu", 1), phi), 
...
typedef model_traditional_negbin_namespace::model_traditional_negbin stan_model;
#ifndef USING_R
