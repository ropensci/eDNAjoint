...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      " (in 'joint_binary_negbin', line 14, column 4 to column 33)",
                                                      " (in 'joint_binary_negbin', line 15, column 4 to column 22)",
                                                      " (in 'joint_binary_negbin', line 16, column 4 to column 23)",
                                                      " (in 'joint_binary_negbin', line 17, column 4 to column 26)",
                                                      " (in 'joint_binary_negbin', line 20, column 2 to column 43)",
                                                      " (in 'joint_binary_negbin', line 21, column 2 to column 40)",
                                                      " (in 'joint_binary_negbin', line 23, column 4 to column 41)",
                                                      " (in 'joint_binary_negbin', line 24, column 4 to column 33)",
                                                      " (in 'joint_binary_negbin', line 22, column 19 to line 25, column 3)",
                                                      " (in 'joint_binary_negbin', line 22, column 2 to line 25, column 3)",
                                                      " (in 'joint_binary_negbin', line 40, column 2 to column 22)",
                                                      " (in 'joint_binary_negbin', line 41, column 2 to column 11)",
                                                      " (in 'joint_binary_negbin', line 42, column 2 to column 21)",
                                                      " (in 'joint_binary_negbin', line 44, column 10 to column 65)",
                                                      " (in 'joint_binary_negbin', line 43, column 17 to line 45, column 7)",
                                                      " (in 'joint_binary_negbin', line 43, column 4 to line 45, column 7)",
                                                      " (in 'joint_binary_negbin', line 47, column 10 to column 61)",
                                                      " (in 'joint_binary_negbin', line 46, column 19 to line 48, column 7)",
                                                      " (in 'joint_binary_negbin', line 46, column 6 to line 48, column 7)",
                                                      " (in 'joint_binary_negbin', line 29, column 8 to column 45)",
                                                      " (in 'joint_binary_negbin', line 28, column 18 to line 30, column 5)",
                                                      " (in 'joint_binary_negbin', line 28, column 4 to line 30, column 5)",
                                                      " (in 'joint_binary_negbin', line 32, column 8 to column 39)",
                                                      " (in 'joint_binary_negbin', line 31, column 18 to line 33, column 5)",
                                                      " (in 'joint_binary_negbin', line 31, column 4 to line 33, column 5)",
                                                      " (in 'joint_binary_negbin', line 35, column 2 to column 47)",
                                                      " (in 'joint_binary_negbin', line 36, column 2 to column 22)",
                                                      " (in 'joint_binary_negbin', line 37, column 2 to column 42)",
                                                      " (in 'joint_binary_negbin', line 2, column 4 to column 19)",
                                                      " (in 'joint_binary_negbin', line 3, column 4 to column 19)",
                                                      " (in 'joint_binary_negbin', line 4, column 10 to column 11)",
                                                      " (in 'joint_binary_negbin', line 4, column 4 to column 28)",
                                                      " (in 'joint_binary_negbin', line 5, column 10 to column 11)",
                                                      " (in 'joint_binary_negbin', line 5, column 4 to column 28)",
                                                      " (in 'joint_binary_negbin', line 6, column 4 to column 22)",
                                                      " (in 'joint_binary_negbin', line 7, column 10 to column 11)",
                                                      " (in 'joint_binary_negbin', line 7, column 4 to column 28)",
                                                      " (in 'joint_binary_negbin', line 8, column 10 to column 11)",
                                                      " (in 'joint_binary_negbin', line 8, column 4 to column 28)",
                                                      " (in 'joint_binary_negbin', line 9, column 10 to column 11)",
                                                      " (in 'joint_binary_negbin', line 9, column 4 to column 28)",
                                                      " (in 'joint_binary_negbin', line 10, column 4 to column 28)",
                                                      " (in 'joint_binary_negbin', line 11, column 4 to column 28)",
                                                      " (in 'joint_binary_negbin', line 14, column 10 to column 14)",
                                                      " (in 'joint_binary_negbin', line 20, column 8 to column 12)",
                                                      " (in 'joint_binary_negbin', line 21, column 8 to column 12)",
                                                      " (in 'joint_binary_negbin', line 40, column 9 to column 12)"};
...
public:
  ...
  inline std::string model_name() const final { return "model_joint_binary_negbin"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-4-gd72b68b7-dirty", "stancflags = "};
  }
  
  
  model_joint_binary_negbin(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_joint_binary_negbin_namespace::model_joint_binary_negbin";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_joint_binary_negbin_namespace::log_prob";
(void) function__;  // suppress unused var warning
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_joint_binary_negbin_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"mu\",\"type\":{\"name\":\"array\",\"length\":" << Nloc << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"parameters\"},{\"name\":\"phi\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"beta\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"log_p10\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"p11\",\"type\":{\"name\":\"array\",\"length\":" << Nloc << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"transformed_parameters\"},{\"name\":\"p\",\"type\":{\"name\":\"array\",\"length\":" << Nloc << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"transformed_parameters\"},{\"name\":\"log_lik\",\"type\":{\"name\":\"vector\",\"length\":" << log_lik_1dim__ << "},\"block\":\"generated_quantities\"},{\"name\":\"p10\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"}]";
    return s__.str();
