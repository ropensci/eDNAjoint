...
#include "stanExports_traditional_catchability_negbin.h"

RCPP_MODULE(stan_fit4traditional_catchability_negbin_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_traditional_catchability_negbin")
