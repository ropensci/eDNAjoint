...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_traditional_catchability_pois");
    reader.add_event(49, 47, "end", "model_traditional_catchability_pois");
    return reader;
}
#include <stan_meta_header.hpp>
class model_traditional_catchability_pois
  : public stan::model::model_base_crtp<model_traditional_catchability_pois> {
private:
        int C;
        std::vector<int> R;
        int Nloc;
...
typedef model_traditional_catchability_pois_namespace::model_traditional_catchability_pois stan_model;
#ifndef USING_R
