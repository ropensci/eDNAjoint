...
public:
  ...
  model_traditional_catchability_pois(stan::io::var_context& context__,
    ...
    static constexpr const char* function__ =
      "model_traditional_catchability_pois_namespace::model_traditional_catchability_pois";
    // suppress unused var warning
    (void) function__;
    ...
    num_params_r__ = Nloc + nparams;
  }
  inline std::string model_name() const final {
    return "model_traditional_catchability_pois";
  }
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_traditional_catchability_pois_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_traditional_catchability_pois_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    names__ = std::vector<std::string>{"mu_1", "q_trans"};
    if (emit_transformed_parameters__) {
  ...
  write_array(RNG& base_rng, Eigen::Matrix<double,-1,1>& params_r,
    ...
    const size_t num_params__ = (Nloc + nparams);
