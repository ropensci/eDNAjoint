...
#include "stanExports_joint_continuous.h"

RCPP_MODULE(stan_fit4joint_continuous_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_joint_continuous")
