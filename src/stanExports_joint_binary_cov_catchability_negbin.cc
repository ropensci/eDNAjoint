...
#include "stanExports_joint_binary_cov_catchability_negbin.h"

RCPP_MODULE(stan_fit4joint_binary_cov_catchability_negbin_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_joint_binary_cov_catchability_negbin")
