...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_joint_pois");
    reader.add_event(57, 55, "end", "model_joint_pois");
    return reader;
}
#include <stan_meta_header.hpp>
class model_joint_pois
  : public stan::model::model_base_crtp<model_joint_pois> {
private:
        int S;
        int C;
        std::vector<int> L;
...
typedef model_joint_pois_namespace::model_joint_pois stan_model;
#ifndef USING_R
