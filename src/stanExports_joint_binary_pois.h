...
static constexpr std::array<const char*, 45> locations_array__ =
  ...
  " (in 'string', line 13, column 4 to column 33)",
  " (in 'string', line 14, column 4 to column 23)",
  " (in 'string', line 15, column 4 to column 26)",
  " (in 'string', line 18, column 2 to column 43)",
  ...
  " (in 'string', line 22, column 4 to column 33)",
  " (in 'string', line 20, column 19 to line 23, column 3)",
  " (in 'string', line 20, column 2 to line 23, column 3)",
  " (in 'string', line 39, column 2 to column 21)",
  " (in 'string', line 41, column 10 to column 53)",
  " (in 'string', line 40, column 17 to line 42, column 7)",
  " (in 'string', line 40, column 4 to line 42, column 7)",
  " (in 'string', line 44, column 10 to column 61)",
  " (in 'string', line 43, column 19 to line 45, column 7)",
  " (in 'string', line 43, column 6 to line 45, column 7)",
  " (in 'string', line 27, column 8 to column 33)",
  " (in 'string', line 26, column 17 to line 28, column 5)",
  " (in 'string', line 26, column 4 to line 28, column 5)",
  " (in 'string', line 30, column 8 to column 39)",
  " (in 'string', line 29, column 18 to line 31, column 5)",
  ...
  " (in 'string', line 18, column 8 to column 12)",
