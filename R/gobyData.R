...
#'   eDNA sample replicate (column). Data includes 39 total sites and a maximum
#'   of 22 eDNA sample replicates. NA indicates that fewer eDNA samples were
#'   collected than the maximum at a site.}
#'   \item{qPCR.K}{Total number of positive eDNA qPCR detections at each site
#'   (row) and eDNA sample replicate (column). Data includes 39 total sites and
#'   a maximum of 22 eDNA sample replicates. NA indicates that fewer eDNA
...
#'   maximum of 22 seine replicates. NA indicates that fewer seine samples were
#'   collected than the maximum at a site.}
...
#'   ('Other_fishes'), size of habitat ('Hab_size'), and presence of vegetation
#'   ('Veg'). All non-integer covariate data is standardized.}
#'}
