...
greencrab.fit.q.pois <- jointModel(data = greencrabData, cov=NULL, 
                                   family = 'poisson', 
                                   p10priors = c(1,20), q=TRUE,
                                   multicore=FALSE)
```
...
greencrab.fit.negbin <- jointModel(data = greencrabData, cov=NULL, 
                                   family = 'negbin', 
                                   p10priors = c(1,20), q=FALSE, 
                                   multicore=FALSE)
greencrab.fit.pois <- jointModel(data = greencrabData, cov=NULL, 
                                 family = 'poisson', 
                                 p10priors = c(1,20), q=FALSE, 
                                 multicore=FALSE)
```
